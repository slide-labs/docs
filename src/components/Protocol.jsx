...
const resources = [
  {
    href: '/protocol/initialization',
    name: 'Initialization',
    description:
      'A new way to build and manage your social trade. Coming soon.',
    icon: UserIcon,
    pattern: {
      y: 16,
      squares: [
...
function ProtocolItem({ resource }) {
    ...
    <div className="my-16 xl:max-w-none">
      ...
      <div className="not-prose mt-4 grid grid-cols-1 gap-8 border-t border-zinc-900/5 pt-10 dark:border-white/5 sm:grid-cols-2 xl:grid-cols-4">
        {resources.map((resource) => (
          <ProtocolItem key={resource.href} resource={resource} />
        ))}
      </div>
    </div>
  )
