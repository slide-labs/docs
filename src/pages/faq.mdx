...
Leveraging in trading involves borrowing funds to invest in financial markets, enabling traders to control larger positions in financial instruments than they could with their own capital.

## What is liquidation?

In trading, liquidation can refer to the forced closing of a trader's position by a broker or exchange to mitigate risk. This can occur when a trader's account balance falls below a certain threshold, known as the maintenance margin requirement.
